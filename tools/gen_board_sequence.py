...
def main():
    ...
    with open(tcl, "w") as f:
        ...
        f.write("# Programs nothing: run this after the ELF is downloaded and\n")
        f.write("# before it is resumed, or halt the core first.\n")
        f.write("connect\n")
        ...
        f.write('puts "manifest at 0x%08X -- resume the core"\n' % MANIFEST_ADDR)
        f.write("con\n")
